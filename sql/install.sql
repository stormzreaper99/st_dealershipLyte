...
CREATE TABLE IF NOT EXISTS `st_dealership_vehicles` (
    ...
    INDEX (`dealership`, `status`), INDEX (`model`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `st_dealership_vehicle_history` (`id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, `vin` VARCHAR(20) NOT NULL, `event` VARCHAR(40) NOT NULL, `details` LONGTEXT DEFAULT NULL, `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX (`vin`)) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `st_dealership_contracts` (`id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, `vin` VARCHAR(20) NOT NULL, `dealership` VARCHAR(50) NOT NULL, `buyer_citizenid` VARCHAR(50) NOT NULL, `salesperson_citizenid` VARCHAR(50) DEFAULT NULL, `sale_price` DECIMAL(12,2) NOT NULL, `trade_in_vin` VARCHAR(20) DEFAULT NULL, `down_payment` DECIMAL(12,2) NOT NULL DEFAULT 0, `financed` TINYINT(1) NOT NULL DEFAULT 0, `apr` DECIMAL(6,4) DEFAULT NULL, `term_months` INT UNSIGNED DEFAULT NULL, `warranty_json` LONGTEXT DEFAULT NULL, `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `st_dealership_loans` (`id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, `contract_id` INT UNSIGNED NOT NULL, `citizenid` VARCHAR(50) NOT NULL, `vin` VARCHAR(20) NOT NULL, `principal` DECIMAL(12,2) NOT NULL, `apr` DECIMAL(6,4) NOT NULL, `term_months` INT UNSIGNED NOT NULL, `monthly_payment` DECIMAL(12,2) NOT NULL, `balance` DECIMAL(12,2) NOT NULL, `missed_payments` INT UNSIGNED NOT NULL DEFAULT 0, `missed_at` TIMESTAMP NULL DEFAULT NULL, `next_due_at` TIMESTAMP NOT NULL, `status` VARCHAR(20) NOT NULL DEFAULT 'active', `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX (`citizenid`), INDEX (`status`)) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `st_dealership_financing_requests` (`id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, `dealership` VARCHAR(50) NOT NULL, `vin` VARCHAR(20) NOT NULL, `citizenid` VARCHAR(50) NOT NULL, `sale_price` DECIMAL(12,2) NOT NULL, `down_payment` DECIMAL(12,2) NOT NULL, `term_months` INT UNSIGNED NOT NULL, `apr` DECIMAL(6,4) NOT NULL, `status` VARCHAR(20) NOT NULL DEFAULT 'pending', `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX (`dealership`, `status`)) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `st_dealership_auctions` (`id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, `vin` VARCHAR(20) NOT NULL, `source_type` VARCHAR(20) NOT NULL DEFAULT 'random', `starting_bid` DECIMAL(12,2) NOT NULL, `current_bid` DECIMAL(12,2) NOT NULL, `current_bidder` VARCHAR(50) DEFAULT NULL, `seller_dealership` VARCHAR(50) DEFAULT NULL, `ends_at` TIMESTAMP NOT NULL, `status` VARCHAR(20) NOT NULL DEFAULT 'open', `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB;
CREATE TABLE IF NOT EXISTS `st_dealership_auction_bids` (`id` INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, `auction_id` INT UNSIGNED NOT NULL, `dealership` VARCHAR(50) NOT NULL, `amount` DECIMAL(12,2) NOT NULL, `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX (`auction_id`)) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `st_dealership_display_assignments` (`zone_id` INT UNSIGNED NOT NULL PRIMARY KEY, `dealership` VARCHAR(50) NOT NULL, `vin` VARCHAR(20) NOT NULL, `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX (`dealership`)) ENGINE=InnoDB;
